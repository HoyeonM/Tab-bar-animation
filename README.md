...
### I used DOM selector. I used loop(foreach) to go through selected querys, by that I removed and added "active" class to specific DOM element to change display option whether it appears or not.
